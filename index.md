...
## 💡 **About**  
안녕하세요. 주로 백엔드 개발을 하고 있고, 프론트 개발도 함께 하고있는 이대건입니다.
...
1) **1인 개발임을 감안하며, 내부망 서비스임을 착안해 Streamlit을 이용한 빠른 프론트엔드 구축**  
     - Streamlit을 통해 자막 데이터 CRUD 및 편집 UI/기능 개발.  
     - 내부 API 상호작용 모듈 개발.  
...
3) **Docker를 통해 빠른 배포, 쉬운 운영 환경 구성**  
...
### 🌐 **외주 홈페이지 개발**
**(소규모) 개인 목적으로 웹 제작 서비스 소개 홈페이지 개발**
